...
public class Utenti {
  ...
  private static String controlloPassUguale(String pw1, String pw2)
    throws IOException {
    do {
      if (pw1.equals(pw2)) {
   ...
   */
  public static String controlloUserEsistente(String username)
    throws IOException {
    boolean esisteut;
    do {
  ...
  static String LunghezzaNome(String nome) throws IOException {
    do {
      if (nome != null && nome.length() >= 3) {
        ...
        System.out.println(
          "non hai inserito nessun nome o il nome inserito è tropppo corto."
        );
  ...
  private static String soloLettere(String nominativo) throws IOException {
    do {
      if (nominativo.matches("[a-zA-Z]*${3,20}")) {
        ...
        System.out.println(
          "il nominativo appena inserito contiene numeri o caratteri speciali."
        );
        System.out.println("reinserire il nominativo con solo lettere");
  ...
  static String LunghezzaCognome(String cognome) throws IOException {
    do {
      if (cognome != null && cognome.length() >= 3) {
        ...
        System.out.println(
          "non hai inserito nessun cognome o il cognome appena inserito è troppo corto."
        );
  ...
  public static String controlloNumeroCivico(String numcivico)
    throws IOException {
    while (!numcivico.matches("[0-9]+([A-Za-z]*)")) {
      System.out.println("il numero civico inserito non rispetta il formato");
      System.out.println(
        "Deve iniziare con un numero di lunghezza massima di tre cifre ed una lettera."
      );
   ...
   */
  public static void ScriviFile(String testo, String filePath)
    throws IOException {
  ...
  public static boolean Login(String Id, String Pw) throws IOException {
    ...
    if (!esiste) {
      ...
      System.out.println(
        "inserimento sbagliato dello UserId e/o della password ."
      );
  ...
  private static boolean esisteUtente(String nomeUtente) throws IOException {
    ...
    while ((str = br.readLine()) != null) {
      supporto = str.split("\\|");
      if (supporto[9].equals(nomeUtente)) return true;
    }
    br.close();
    return false;
  }
